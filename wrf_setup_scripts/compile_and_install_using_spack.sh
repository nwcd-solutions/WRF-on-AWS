...
then
    ...
    python3 ${SHARED_DIR}/wrf-on-aws/wrf_setup_scripts/update_packages_yaml.py  ${SHARED_DIR}/spack/etc/spack/packages.yaml.old >  ${SHARED_DIR}/spack/etc/spack/packages.yaml
